...
public class RemoteStoreServer {
   ...
   public RemoteStoreServer(int port, List<TupleThree<String, String, Integer>> storeList, boolean delay) {
    ...
    protected void initConfig(RemoteConfig remoteConfig) {
        ...
        //set server message received log frequency
//        if ( remoteConfig.getFreq() > 1) {
//            logger.info("Set server message received freqency "+remoteConfig.getFreq());
//            ((StoreServerHandler) handler).setFreq( remoteConfig.getFreq());
//        }
